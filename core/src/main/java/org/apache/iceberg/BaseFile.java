...
abstract class BaseFile<F> extends SupportsIndexProjection
  ...
  private String clusterCubeId = null;
  private Integer clusterSpecId = null;
  ...
  private static final Types.StructType BASE_TYPE =
      Types.StructType.of(
          ...
          DataFile.CLUSTER_CUBE_ID,
          DataFile.CLUSTER_SPEC_ID,
  ...
  BaseFile(BaseFile<F> toCopy, boolean copyStats, Set<Integer> requestedColumnIds) {
    ...
    this.clusterCubeId = toCopy.clusterCubeId;
    this.clusterSpecId = toCopy.clusterSpecId;
  }
  ...
  protected <T> void internalSet(int pos, T value) {
    switch (pos) {
      ...
      case 20:
        ...
        return;
      case 21:
        this.clusterCubeId = value != null ? value.toString() : null;
        return;
      case 22:
        this.clusterSpecId = (Integer) value;
        return;
      case 23:
  ...
  @Override
  public String clusterCubeId() {
    return clusterCubeId;
  }

  @Override
  public Integer clusterSpecId() {
    return clusterSpecId;
  }
